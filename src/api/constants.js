...
module.exports = {
    ...
    LIST_GUESTBOOK_URL: `${MOBILE_BASE_URL}/ajax/response-galloglistGb`,
    ...
    NEW_MINOR_URL: `${JSON_BASE_URL}/json1/mgallmain/mgallery_new.php`,
    NEW_MINI_URL: `${JSON_BASE_URL}/json1/migallmain/migallery_new.php`,
